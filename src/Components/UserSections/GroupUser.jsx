                                    ...
                                    <div className="ps-3">
                                        <nav aria-label="breadcrumb">
                                            <ol className="breadcrumb mb-0 p-0" style={{ alignItems: 'center', display: 'flex' }}>
                                                ...
                                                <li><ChevronRightIcon />  {'Group User'}</li>
                                            </ol>
                                        </nav>
                                    </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <div className="card-title" style={{ justifyContent: 'space-between' }}  >
                                            <h4 className="mb-0">Group User</h4>
                                        </div>
                                                            ...
                                                            <tbody>
                                                                {filteredData.map((row) => (
                                                                    <tr>
                                                                        ...
                                                                        <td>2011/04/25</td>
                                                                        <td>{row.selery}</td>
                                                                        <td >  <abbr onClick={() => navigate('/SingleUser')} title='User'>  <PersonIcon style={{ color: 'hotpink' }} /></abbr> <abbr title='Group'> <GroupIcon style={{ color: 'hotpink' }} /></abbr> </td>
                                                                    </tr>
                                                                ))}
