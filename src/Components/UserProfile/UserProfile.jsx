                                            ...
                                            <div className="col-12 col-lg-7 border-right">
                                                <div className="d-md-flex align-items-center">
                                                    ...
                                                    <div className="ms-md-4 flex-grow-1">
                                                        ...
                                                        <p className="text-primary"><i className="bx bx-buildings" /> Epic Coders</p>
                                                        <div style={{ display: 'flex', gap: '10px' }}>

                                                            <button style={{ background: '#673AB7' }} type="button" className="btn btn-primary">Edit Image</button>
                                                            <button type="button" className="btn btn-outline-secondary ml-2">Resume</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-12 col-lg-5">
                                                <table className="table table-sm table-borderless mt-md-0 mt-3">
                                                    <tbody>
                                                        <tr>
                                                            <th>Availability:</th>
                                                            <td>Full-time (40hr/wk) <span className="badge badge-success">available</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Age:</th>
                                                ...
                                                <div className="mb-3 mb-lg-0">
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-github" /></a>
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-twitter" /></a>
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-facebook" /></a>
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-linkedin" /></a>
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-dribbble" /></a>
                                                    <a href="javascript:;" className="btn btn-sm btn-link"><i className="bx bxl-stack-overflow" /></a>
                                                </div>
                                            </div>
                                        </div>
                                        {/*end row*/}
                                        <ul className="nav nav-pills">
                                            <li className="nav-item"> <a className="nav-link" data-bs-toggle="tab"><span className="p-tab-name">Edit Profile</span><i className="bx bx-message-edit font-24 d-sm-none" /></a>
                                            </li>
                                        </ul>
                                                                ...
                                                                <div className="col-12 col-lg-5 border-right">
                                                                    <form className="row g-3">
                                                                        <div className="col-6">
                                                                            ...
                                                                            <input type="text" defaultValue="Svetlana" className="form-control" />
                                                                        </div>
                                                                        <div className="col-6">
                                                                            <label className="form-label">Last Name</label>
                                                                            <input type="text" defaultValue="Anyukova" className="form-control" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Password</label>
                                                                            <input type="password" defaultValue={1234560000} className="form-control" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Email</label>
                                                                            <input type="text" defaultValue="svetlana1997@example.com" className="form-control" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Phone</label>
                                                                            <input type="text" defaultValue="99-10-XXX-XXX" className="form-control" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Address</label>
                                                                            <input type="text" defaultValue="116-B, Cutela Colony, Sydney, Australia" className="form-control" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Nation</label>
                                                                            <input type="text" defaultValue="Australia" className="form-control" />
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <div className="col-12 col-lg-7">
                                                                    <form className="row g-3">
                                                                        ...
                                                                        <div className="col-12">
                                                                            ...
                                                                            <input type="text" className="form-control" defaultValue="https://twitter.com/anyukova" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Linked In</label>
                                                                            <input type="text" className="form-control" defaultValue="https://www.linkedin.com/anyukova/" />
                                                                        </div>
                                                                        <div className="col-12">
                                                                            <label className="form-label">Facebook</label>
                                                                            <input type="text" className="form-control" defaultValue="https://www.facebook.com/anyukova" />
                                                                        </div>
                                                                        {/*
                                                          <div class="col-12">
